# quaid-scanner Report: /Users/karstenwade/Projects/AINative-Studio/src/ainative-ecosystem

**Score:** 🔴 1.9/10 — CRITICAL risk
**Maturity:** sandbox | **Depth:** standard | **Duration:** 0.1s
**Scanned:** 2026-06-01T21:23:15.241Z
...
- **[vendor-neutrality-high-concentration]** High vendor concentration: gmail.com (71% of commits) *(Encourage contributions from additional organizations to improve vendor diversity)*
...
- **[bus-factor-1]** Bus factor: 1, Elephant factor: 71% (2 contributors, 7 commits in last 12 months)
...
- **[vendor-neutrality-domain-count]** Found 2 unique email domain(s) across 7 commits
...
- **[contributor-data-1]** 2 unique contributors with 7 commits in the last 12 months
...
- **[AK-GIT-FORK-README.md:11]** Assumed knowledge: "fork" operation used without explanation
- **[AK-ACRONYM-CONTRIBUTING-README.md:15]** Undefined acronym "CONTRIBUTING" may confuse newcomers
- **[AK-ACRONYM-LICENSE-README.md:39]** Undefined acronym "LICENSE" may confuse newcomers
- **[AK-TOOL-PIP-CONTRIBUTING.md:45]** Assumed knowledge: "pip" command used without Python listed as prerequisite
- **[AK-ACRONYM-SPDX-CONTRIBUTING.md:36]** Undefined acronym "SPDX" may confuse newcomers
- **[AK-ACRONYM-LLM-CONTRIBUTING.md:65]** Undefined acronym "LLM" may confuse newcomers
- **[AK-ACRONYM-RAG-CONTRIBUTING.md:77]** Undefined acronym "RAG" may confuse newcomers
...
---
*quaid-scanner v0.1.2 | 2026-06-01T21:23:15.241Z*
*Commit: e583bb6a07868c023f5b75c759b6c278b42e2f2e*